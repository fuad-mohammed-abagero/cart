...
import { CartContext, resetCart } from "../../ContextProvider";
...
function ConfirmModal() {
  ...
  return (
    <>
      ...
      <div className="fixed left-1/2 p-4 w-80 top-1/2 translate-x-[-50%] flex flex-col gap-1 translate-y-[-50%] bg-rose-50 rounded-lg">
        <div>
          <svg
            width="48"
            height="48"
        ...
        <hl>Order Confirmed</hl>
        <p>we hope you enjoy your food</p>
        <div className="px-4 py-1 rounded-md bg-rose-100">
          {state.cart.map((item) => (
            <ConfirmModalItem key={item.name} item={item} />
          ))}
        ...
        <button
          className="p-2 mt-2 bg-red-500 rounded-full text-stone-300"
