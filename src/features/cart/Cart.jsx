...
import { CartContext, completeCart } from "../../ContextProvider";
function Cart() {
  ...
  if (!cart.length) {
    return (
      <div className="flex  flex-col flex-none p-4 mx-auto bg-white rounded-md h-fit     max-w-[384px] basis-96  ">
        <h1 className="text-xl font-semibold text-red-500 ">Your Cart</h1>
        <div className="flex flex-col items-center justify-center p-4 text-stone-300">
          ...
          >
            ...
            <path
              fill="#87635A"
              d="M7.45 51.793c-.96 8.48 16.746 17.44 39.466 19.947 22.72 2.506 42.08-2.16 43.04-10.667l-3.947 35.493c-.96 8.48-20.24 13.334-43.04 10.667S2.463 95.74a 3.423 87.18l4.026-35.387Z"
            />
            <path
              fill="#AD8A85"
  ...
  return (
    <div className="flex flex-col flex-none p-4 mx-auto bg-white rounded-md h-fit     max-w-[384px] basis-96  ">
      ...
      <div className="flex items-center justify-between p-2">
        <span className="my-2 text-xl">Total Order</span>
        <span className="text-3xl font-semibold">${totalPrice}</span>
      </div>
      <p className="flex items-center justify-center gap-1 p-4 rounded-md bg-rose-50">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="21"
          height="20"
      ...
      <button
        onClick={() => dispatch(completeCart())}
        className="p-4 mt-2 bg-red-500 rounded-full text-stone-300"
      >
        Confirm Order
      </button>
    </div>
